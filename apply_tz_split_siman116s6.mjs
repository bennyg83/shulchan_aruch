...
const ep = path.join(base,'siman116','seif-006','turei-zahav','en.html');
const hp = path.join(base,'siman116','seif-006','turei-zahav','he.html');
...
// HE[1] starts at "I found in an old collection"
const SPLIT1 = 'I found in an old collection';
// HE[2] starts at "We further find that the Sages forbade"
const SPLIT2 = 'We further find that the Sages forbade';
// HE[3] starts at "Rashal wrote in the last chapter"
const SPLIT3 = 'Rashal wrote in the last chapter';
...
console.log(`\nSeg0 (${seg0.length}): ...${seg0.slice(-60)}`);
