...
**Daily on slave:** `powershell -ExecutionPolicy Bypass -File C:\eh001-slave\Start-OllamaServe.ps1`
...
```
EH001_OLLAMA_URL=http://10.100.102.14:11434
EH001_OLLAMA_MODEL=qwen2.5:14b-instruct
```
