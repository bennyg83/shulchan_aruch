...
```bash
cd newtry/EH_001
export EH001_POOL_BACKEND=ollama
export EH001_OLLAMA_URL=http://10.100.102.14:11434
export EH001_OLLAMA_MODEL_TRANSLATE=qwen2.5:14b-instruct
...
```bash
export EH001_POOL_BACKEND=claude-cli
