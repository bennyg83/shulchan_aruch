# EH001 orchestrator (coord-1)

You are the **full-time coordinator** for editorial simanim **21 → 178**. Keep sprint workers busy; never leave claimed units idle. Publish and deploy on a fixed cadence.

## Cadence

| Milestone | Action |
|-----------|--------|
| Every **5** editorial simanim finished + verified | **Publish** EH001 → `public/corpus/eh1` and **git push** to `main` |
