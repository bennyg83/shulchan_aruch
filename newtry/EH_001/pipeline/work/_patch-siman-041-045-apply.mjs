#!/usr/bin/env node
/** EH001 FULL REDO simanim 041–045 — all commentaries, all blocks. */
import fs from "fs";
...
import { MECHABER } from "./_patch-siman-041-045-mechaber.mjs";

const SIMANIM = ["041", "042", "043", "044", "045"];
...
function relPath(sim, slug, part = "part-001.txt") {
  return `siman_${sim}/${slug}/${part}`;
}
...
console.log("\n[COMPLETE] Session done — simanim: 041, 042, 043, 044, 045");
