#!/usr/bin/env node
/** EH001 FULL REDO simanim 061–065 — all commentaries, all blocks. */
import fs from "fs";
import path from "path";
import { execSync } from "child_process";
import { parseBlocksInFile } from "../../eh001_block_lib.mjs";
import { patchFile, ROOT, OUT } from "./_patch-siman-utils.mjs";
import { translateCommentaryFull } from "./_patch-siman-061-065-translate-commentary.mjs";
import { MECHABER } from "./_patch-siman-061-065-mechaber.mjs";

const SIMANIM = ["061", "062", "063", "064", "065"];
...
console.log("\n[COMPLETE] Session done — simanim: 061, 062, 063, 064, 065");
