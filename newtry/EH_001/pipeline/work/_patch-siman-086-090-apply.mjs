#!/usr/bin/env node
/** EH001 FULL REDO simanim 086–090 — all commentaries, all blocks. */
import fs from "fs";
import path from "path";
import { execSync } from "child_process";
import { parseBlocksInFile } from "../../eh001_block_lib.mjs";
import { patchFile, ROOT, OUT } from "./_patch-siman-utils.mjs";
import { translateCommentaryFull } from "./_patch-siman-086-090-translate-commentary.mjs";
import { MECHABER } from "./_patch-siman-086-090-mechaber.mjs";

const SIMANIM = ["086", "087", "088", "089", "090"];
...
function listTxtFiles(sim) {
  ...
  return files.sort((a, b) => {
    ...
    const partA = a.localeCompare(b);
    return (ia === -1 ? 99 : ia) - (ib === -1 ? 99 : ib) || partA;
  });
}
...
console.log("\n[COMPLETE] Session done — simanim: 086, 087, 088, 089, 090");
