#!/usr/bin/env node
/** EH001 FULL REDO simanim 081–085 — all commentaries, all blocks. */
import fs from "fs";
import path from "path";
import { execSync } from "child_process";
import { parseBlocksInFile } from "../../eh001_block_lib.mjs";
import { patchFile, ROOT, OUT } from "./_patch-siman-utils.mjs";
import { translateCommentaryFull } from "./_patch-siman-081-085-translate-commentary.mjs";
import { MECHABER } from "./_patch-siman-081-085-mechaber.mjs";
...
console.log("\n[COMPLETE] Session done — simanim: 081, 082, 083, 084, 085");
