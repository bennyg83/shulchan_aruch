#!/usr/bin/env node
/** EH001 FULL REDO simanim 101–120 — all commentaries, all blocks. */
import fs from "fs";
import path from "path";
import { execSync } from "child_process";
import { parseBlocksInFile } from "../../eh001_block_lib.mjs";
import { patchFile, ROOT, OUT } from "./_patch-siman-utils.mjs";
import { translateCommentaryFull } from "./_patch-siman-101-120-translate-commentary.mjs";
import { MECHABER } from "./_patch-siman-101-120-mechaber.mjs";
import { PITCHEI_TESHUVA } from "./_patch-siman-101-120-pitchei-teshuva.mjs";
...
console.log("\n[COMPLETE] Session done — simanim: 101–120");
