# EH001 editorial worker agent

Branch: **`eh-development`**. Retranslate from Hebrew; do not patch bad English in place.
...
- Open `newtry/EH_001/output/<path>`
