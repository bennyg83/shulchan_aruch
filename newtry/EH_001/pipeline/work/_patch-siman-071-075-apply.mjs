#!/usr/bin/env node
/** EH001 FULL REDO simanim 071–075 — all commentaries, all blocks. */
import fs from "fs";
import path from "path";
import { execSync } from "child_process";
import { parseBlocksInFile } from "../../eh001_block_lib.mjs";
import { patchFile, ROOT, OUT } from "./_patch-siman-utils.mjs";
import { translateCommentaryFull } from "./_patch-siman-071-075-translate-commentary.mjs";
import { MECHABER } from "./_patch-siman-071-075-mechaber.mjs";

const SIMANIM = ["071", "072", "073", "074", "075"];
...
console.log("\n[COMPLETE] Session done — simanim: 071, 072, 073, 074, 075");
