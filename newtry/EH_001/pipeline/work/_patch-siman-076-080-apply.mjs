#!/usr/bin/env node
/** EH001 FULL REDO simanim 076–080 — all commentaries, all blocks. */
import fs from "fs";
import path from "path";
import { execSync } from "child_process";
import { parseBlocksInFile } from "../../eh001_block_lib.mjs";
import { patchFile, ROOT, OUT } from "./_patch-siman-utils.mjs";
import { translateCommentaryFull } from "./_patch-siman-076-080-translate-commentary.mjs";
import { MECHABER } from "./_patch-siman-076-080-mechaber.mjs";

const SIMANIM = ["076", "077", "078", "079", "080"];
...
console.log("\n[COMPLETE] Session done — simanim: 076, 077, 078, 079, 080");
