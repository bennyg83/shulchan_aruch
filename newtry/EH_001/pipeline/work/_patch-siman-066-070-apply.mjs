#!/usr/bin/env node
/** EH001 FULL REDO simanim 066–070 — all commentaries, all blocks. */
import fs from "fs";
import path from "path";
import { execSync } from "child_process";
import { parseBlocksInFile } from "../../eh001_block_lib.mjs";
import { patchFile, ROOT, OUT } from "./_patch-siman-utils.mjs";
import { translateCommentaryFull } from "./_patch-siman-066-070-translate-commentary.mjs";
import { MECHABER } from "./_patch-siman-066-070-mechaber.mjs";
import { PITCHEI_TESHUVA } from "./_patch-siman-066-070-pitchei-teshuva.mjs";

const SIMANIM = ["066", "067", "068", "069", "070"];
...
console.log("\n[COMPLETE] Session done — simanim: 066, 067, 068, 069, 070");
