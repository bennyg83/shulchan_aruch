...
The coordinator assigns work units via `pipeline/work/coordinator-assignments.json` or sprint plans.
...
- **First pass MT:** `npm run libre:up` then `npm run translate:placeholders:libre -- --root output/siman_NNN`
