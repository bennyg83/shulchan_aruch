...
# export YD001_OLLAMA_MODEL=qwen2.5:14b-instruct
...
5. Auto-advances phases and **waves** through siman **403** (`finishThrough` in `master-pipeline-plan.json`)
...
| Phase | Action |
|-------|--------|
| `editorial_6_403` | Watch spawns workers; waves 105→100→296→…→403 |
| `html_presentation` | Stop watch; one HTML agent; `mark-html-complete` |
| `yd_complete` | Watch exits |
