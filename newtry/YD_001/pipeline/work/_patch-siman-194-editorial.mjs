#!/usr/bin/env node
/** Apply editorial translation modules for siman 194 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-194-editorial.mjs _tr-194-baer-heitev.mjs _tr-194-beer-hagolah.mjs _tr-194-beur-hagra.mjs _tr-194-chiddushei-hilkhot-niddah.mjs _tr-194-pitchei-teshuva.mjs _tr-194-siftei-kohen.mjs _tr-194-torat-hashlamim.mjs _tr-194-turei-zahav.mjs');
  process.exit(1);
}
