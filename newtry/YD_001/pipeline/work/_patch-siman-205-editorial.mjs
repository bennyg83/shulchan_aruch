#!/usr/bin/env node
/** Apply editorial translation modules for siman 205 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-205-baer-heitev.mjs',
  '_tr-205-beur-hagra.mjs',
  '_tr-205-pitchei-teshuva.mjs',
  '_tr-205-siftei-kohen.mjs',
  '_tr-205-turei-zahav.mjs',
];
