#!/usr/bin/env node
/** Apply editorial translation modules for siman 298 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-298-editorial.mjs _tr-298-beer-hagolah.mjs _tr-298-beur-hagra.mjs _tr-298-pitchei-teshuva.mjs');
  process.exit(1);
}
