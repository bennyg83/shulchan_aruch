#!/usr/bin/env node
/** Apply editorial translation modules for siman 148 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-148-baer-heitev.mjs',
  '_tr-148-beer-hagolah.mjs',
  '_tr-148-beur-hagra.mjs',
  '_tr-148-nekudot-hakesef.mjs',
  '_tr-148-siftei-kohen.mjs',
  '_tr-148-turei-zahav.mjs',
];
