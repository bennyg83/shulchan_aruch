#!/usr/bin/env node
/** Apply editorial translation modules for siman 220 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-220-baer-heitev.mjs',
  '_tr-220-beer-hagolah.mjs',
  '_tr-220-beur-hagra.mjs',
  '_tr-220-nekudot-hakesef.mjs',
  '_tr-220-pitchei-teshuva.mjs',
  '_tr-220-siftei-kohen.mjs',
  '_tr-220-turei-zahav.mjs',
];
