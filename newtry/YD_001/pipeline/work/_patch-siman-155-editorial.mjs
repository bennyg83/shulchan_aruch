#!/usr/bin/env node
/** Apply editorial translation modules for siman 155 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-155-baer-heitev.mjs',
  '_tr-155-beer-hagolah.mjs',
  '_tr-155-beur-hagra.mjs',
  '_tr-155-pitchei-teshuva.mjs',
  '_tr-155-siftei-kohen.mjs',
  '_tr-155-yad-avraham.mjs',
  '_tr-155-turei-zahav.mjs',
];
