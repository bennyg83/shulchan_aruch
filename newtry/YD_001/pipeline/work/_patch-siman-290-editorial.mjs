#!/usr/bin/env node
/** Apply editorial translation modules for siman 290 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-290-editorial.mjs _tr-290-beer-hagolah.mjs _tr-290-beur-hagra.mjs _tr-290-nekudot-hakesef.mjs _tr-290-turei-zahav.mjs');
  process.exit(1);
}
