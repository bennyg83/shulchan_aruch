#!/usr/bin/env node
/** Apply editorial translation modules for siman 283 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-283-editorial.mjs _tr-283-beer-hagolah.mjs _tr-283-beur-hagra.mjs _tr-283-pitchei-teshuva.mjs _tr-283-siftei-kohen.mjs');
  process.exit(1);
}
