#!/usr/bin/env node
/** Apply editorial translation modules for siman 166 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-166-editorial.mjs _tr-166-baer-heitev.mjs _tr-166-beer-hagolah.mjs _tr-166-beur-hagra.mjs _tr-166-pitchei-teshuva.mjs _tr-166-rabbi-akiva-eiger-yd.mjs _tr-166-siftei-kohen.mjs _tr-166-turei-zahav.mjs _tr-166-yad-avraham.mjs');
  process.exit(1);
}
