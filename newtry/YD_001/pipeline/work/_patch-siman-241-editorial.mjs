#!/usr/bin/env node
/** Apply editorial translation modules for siman 241 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-241-editorial.mjs _tr-241-beer-hagolah.mjs _tr-241-beur-hagra.mjs _tr-241-yad-avraham.mjs');
  process.exit(1);
}
