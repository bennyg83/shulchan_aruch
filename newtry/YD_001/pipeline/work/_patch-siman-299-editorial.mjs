#!/usr/bin/env node
/** Apply editorial translation modules for siman 299 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-299-editorial.mjs _tr-299-beer-hagolah.mjs _tr-299-beur-hagra.mjs _tr-299-nekudot-hakesef.mjs _tr-299-pitchei-teshuva.mjs _tr-299-siftei-kohen.mjs _tr-299-turei-zahav.mjs');
  process.exit(1);
}
