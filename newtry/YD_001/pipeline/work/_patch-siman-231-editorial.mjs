#!/usr/bin/env node
/** Apply editorial translation modules for siman 231 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-231-editorial.mjs _tr-231-beer-hagolah.mjs _tr-231-beur-hagra.mjs _tr-231-turei-zahav.mjs');
  process.exit(1);
}
