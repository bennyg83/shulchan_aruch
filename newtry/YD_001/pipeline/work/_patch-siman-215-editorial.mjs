#!/usr/bin/env node
/** Apply editorial translation modules for siman 215 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-215-baer-heitev.mjs',
  '_tr-215-beer-hagolah.mjs',
  '_tr-215-beur-hagra.mjs',
  '_tr-215-rabbi-akiva-eiger-yd.mjs',
  '_tr-215-siftei-kohen.mjs',
  '_tr-215-turei-zahav.mjs',
  '_tr-215-yad-avraham.mjs',
];
