#!/usr/bin/env node
/** Apply editorial translation modules for siman 191 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-191-editorial.mjs _tr-191-beer-hagolah.mjs _tr-191-beur-hagra.mjs _tr-191-chiddushei-hilkhot-niddah.mjs _tr-191-pitchei-teshuva.mjs _tr-191-siftei-kohen.mjs _tr-191-tiferet-yisrael.mjs');
  process.exit(1);
}
