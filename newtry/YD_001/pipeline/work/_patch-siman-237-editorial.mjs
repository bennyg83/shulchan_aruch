#!/usr/bin/env node
/** Apply editorial translation modules for siman 237 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-237-editorial.mjs _tr-237-baer-heitev.mjs _tr-237-beer-hagolah.mjs _tr-237-beur-hagra.mjs _tr-237-siftei-kohen.mjs _tr-237-turei-zahav.mjs');
  process.exit(1);
}
