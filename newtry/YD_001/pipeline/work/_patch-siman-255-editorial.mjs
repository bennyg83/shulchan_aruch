#!/usr/bin/env node
/** Apply editorial translation modules for siman 255 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-255-editorial.mjs _tr-255-beer-hagolah.mjs _tr-255-beur-hagra.mjs');
  process.exit(1);
}
