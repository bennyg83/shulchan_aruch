#!/usr/bin/env node
/** Apply editorial translation modules for siman 249 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-249-editorial.mjs _tr-249-baer-heitev.mjs _tr-249-beer-hagolah.mjs _tr-249-beur-hagra.mjs _tr-249-nekudot-hakesef.mjs _tr-249-pitchei-teshuva.mjs _tr-249-turei-zahav.mjs');
  process.exit(1);
}
