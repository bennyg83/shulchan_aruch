#!/usr/bin/env node
/** Apply editorial translation modules for siman 286 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-286-editorial.mjs _tr-286-baer-heitev.mjs _tr-286-beer-hagolah.mjs _tr-286-beur-hagra.mjs _tr-286-pitchei-teshuva.mjs _tr-286-siftei-kohen.mjs _tr-286-turei-zahav.mjs');
  process.exit(1);
}
