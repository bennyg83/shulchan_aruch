#!/usr/bin/env node
/** Generic editorial patch applier — pass siman number and _tr module names */
import fs from 'fs';
...
if (!siman || !modules.length) {
  console.error('Usage: node _patch-siman-editorial.mjs NNN _tr-NNN-slug.mjs ...');
  process.exit(1);
}
...
console.log(`[DONE] siman_${siman}: ${total} blocks`);
