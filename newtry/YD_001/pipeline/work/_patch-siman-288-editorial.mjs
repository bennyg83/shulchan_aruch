#!/usr/bin/env node
/** Apply editorial translation modules for siman 288 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-288-editorial.mjs _tr-288-baer-heitev.mjs _tr-288-beer-hagolah.mjs _tr-288-beur-hagra.mjs _tr-288-pitchei-teshuva.mjs _tr-288-rabbi-akiva-eiger-yd.mjs _tr-288-siftei-kohen.mjs _tr-288-turei-zahav.mjs');
  process.exit(1);
}
