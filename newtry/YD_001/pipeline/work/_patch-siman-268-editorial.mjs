#!/usr/bin/env node
/** Apply editorial translation modules for siman 268 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-268-editorial.mjs _tr-268-baer-heitev.mjs _tr-268-beer-hagolah.mjs _tr-268-beur-hagra.mjs _tr-268-pitchei-teshuva.mjs _tr-268-siftei-kohen.mjs _tr-268-turei-zahav.mjs _tr-268-yad-avraham.mjs');
  process.exit(1);
}
