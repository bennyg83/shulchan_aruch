#!/usr/bin/env node
/** Apply editorial translation modules for siman 193 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-193-editorial.mjs _tr-193-baer-heitev.mjs _tr-193-beer-hagolah.mjs _tr-193-beur-hagra.mjs _tr-193-chiddushei-hilkhot-niddah.mjs _tr-193-tiferet-yisrael.mjs _tr-193-torat-hashlamim.mjs _tr-193-turei-zahav.mjs');
  process.exit(1);
}
