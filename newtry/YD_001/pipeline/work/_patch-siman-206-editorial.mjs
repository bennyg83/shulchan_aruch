#!/usr/bin/env node
/** Apply editorial translation modules for siman 206 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-206-baer-heitev.mjs',
  '_tr-206-beer-hagolah.mjs',
  '_tr-206-beur-hagra.mjs',
  '_tr-206-rabbi-akiva-eiger-yd.mjs',
  '_tr-206-siftei-kohen.mjs',
  '_tr-206-turei-zahav.mjs',
];
