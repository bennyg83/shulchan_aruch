#!/usr/bin/env node
/** Apply editorial translation modules for siman 211 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-211-baer-heitev.mjs',
  '_tr-211-beer-hagolah.mjs',
  '_tr-211-beur-hagra.mjs',
  '_tr-211-nekudot-hakesef.mjs',
  '_tr-211-rabbi-akiva-eiger-yd.mjs',
  '_tr-211-siftei-kohen.mjs',
  '_tr-211-turei-zahav.mjs',
];
