#!/usr/bin/env node
/** Apply editorial translation modules for siman 153 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-153-beer-hagolah.mjs',
  '_tr-153-beur-hagra.mjs',
  '_tr-153-pitchei-teshuva.mjs',
  '_tr-153-yad-avraham.mjs',
  '_tr-153-yad-ephraim.mjs',
];
