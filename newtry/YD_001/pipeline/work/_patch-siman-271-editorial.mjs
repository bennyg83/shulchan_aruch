#!/usr/bin/env node
/** Apply editorial translation modules for siman 271 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-271-editorial.mjs _tr-271-beer-hagolah.mjs _tr-271-beur-hagra.mjs _tr-271-rabbi-akiva-eiger-yd.mjs _tr-271-turei-zahav.mjs');
  process.exit(1);
}
