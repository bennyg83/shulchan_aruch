#!/usr/bin/env node
/** Apply editorial translation modules for siman 218 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-218-baer-heitev.mjs',
  '_tr-218-beer-hagolah.mjs',
  '_tr-218-beur-hagra.mjs',
  '_tr-218-pitchei-teshuva.mjs',
  '_tr-218-rabbi-akiva-eiger-yd.mjs',
  '_tr-218-siftei-kohen.mjs',
  '_tr-218-turei-zahav.mjs',
];
