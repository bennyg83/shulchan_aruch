#!/usr/bin/env node
/** Apply editorial translation modules for siman 266 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-266-editorial.mjs _tr-266-baer-heitev.mjs _tr-266-beer-hagolah.mjs _tr-266-beur-hagra.mjs _tr-266-pitchei-teshuva.mjs _tr-266-rabbi-akiva-eiger-yd.mjs _tr-266-siftei-kohen.mjs _tr-266-turei-zahav.mjs');
  process.exit(1);
}
