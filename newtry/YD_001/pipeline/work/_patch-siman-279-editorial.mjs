#!/usr/bin/env node
/** Apply editorial translation modules for siman 279 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-279-editorial.mjs _tr-279-baer-heitev.mjs _tr-279-beur-hagra.mjs _tr-279-pitchei-teshuva.mjs _tr-279-siftei-kohen.mjs _tr-279-turei-zahav.mjs');
  process.exit(1);
}
