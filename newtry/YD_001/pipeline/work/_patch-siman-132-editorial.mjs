#!/usr/bin/env node
/** Apply editorial translation modules for siman 132 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-132-baer-heitev.mjs',
  '_tr-132-beer-hagolah.mjs',
  '_tr-132-beur-hagra.mjs',
  '_tr-132-mateh-yehonatan.mjs',
  '_tr-132-siftei-kohen.mjs',
  '_tr-132-turei-zahav.mjs',
  '_tr-132-yad-ephraim.mjs',
];
