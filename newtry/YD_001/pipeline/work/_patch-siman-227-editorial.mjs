#!/usr/bin/env node
/** Apply editorial translation modules for siman 227 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-227-editorial.mjs _tr-227-baer-heitev.mjs _tr-227-beer-hagolah.mjs _tr-227-beur-hagra.mjs _tr-227-pitchei-teshuva.mjs _tr-227-siftei-kohen.mjs _tr-227-turei-zahav.mjs');
  process.exit(1);
}
