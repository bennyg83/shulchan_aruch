#!/usr/bin/env node
/** Apply editorial translation modules for siman 199 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-199-editorial.mjs _tr-199-baer-heitev.mjs _tr-199-beer-hagolah.mjs _tr-199-beur-hagra.mjs _tr-199-nekudot-hakesef.mjs _tr-199-pitchei-teshuva.mjs _tr-199-siftei-kohen.mjs _tr-199-turei-zahav.mjs');
  process.exit(1);
}
