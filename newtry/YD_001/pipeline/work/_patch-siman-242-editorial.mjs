#!/usr/bin/env node
/** Apply editorial translation modules for siman 242 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-242-editorial.mjs _tr-242-baer-heitev.mjs _tr-242-beer-hagolah.mjs _tr-242-beur-hagra.mjs _tr-242-pitchei-teshuva.mjs _tr-242-rabbi-akiva-eiger-yd.mjs _tr-242-siftei-kohen.mjs _tr-242-turei-zahav.mjs _tr-242-yad-avraham.mjs');
  process.exit(1);
}
