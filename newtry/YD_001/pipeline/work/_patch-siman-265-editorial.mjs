#!/usr/bin/env node
/** Apply editorial translation modules for siman 265 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-265-editorial.mjs _tr-265-baer-heitev.mjs _tr-265-beer-hagolah.mjs _tr-265-beur-hagra.mjs _tr-265-pitchei-teshuva.mjs _tr-265-siftei-kohen.mjs _tr-265-turei-zahav.mjs');
  process.exit(1);
}
