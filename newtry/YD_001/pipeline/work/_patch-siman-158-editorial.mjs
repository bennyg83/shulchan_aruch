#!/usr/bin/env node
/** Apply editorial translation modules for siman 158 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-158-editorial.mjs _tr-158-baer-heitev.mjs _tr-158-beer-hagolah.mjs _tr-158-beur-hagra.mjs _tr-158-nekudot-hakesef.mjs _tr-158-pitchei-teshuva.mjs _tr-158-rabbi-akiva-eiger-yd.mjs _tr-158-turei-zahav.mjs');
  process.exit(1);
}
