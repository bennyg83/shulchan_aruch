#!/usr/bin/env node
/** Apply editorial translation modules for siman 246 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-246-editorial.mjs _tr-246-baer-heitev.mjs _tr-246-beer-hagolah.mjs _tr-246-beur-hagra.mjs _tr-246-pitchei-teshuva.mjs _tr-246-rabbi-akiva-eiger-yd.mjs _tr-246-siftei-kohen.mjs _tr-246-yad-avraham.mjs');
  process.exit(1);
}
