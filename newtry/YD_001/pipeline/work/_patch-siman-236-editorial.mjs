#!/usr/bin/env node
/** Apply editorial translation modules for siman 236 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-236-editorial.mjs _tr-236-baer-heitev.mjs _tr-236-beur-hagra.mjs _tr-236-nekudot-hakesef.mjs _tr-236-pitchei-teshuva.mjs _tr-236-rabbi-akiva-eiger-yd.mjs _tr-236-siftei-kohen.mjs _tr-236-turei-zahav.mjs');
  process.exit(1);
}
