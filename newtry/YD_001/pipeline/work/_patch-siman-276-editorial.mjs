#!/usr/bin/env node
/** Apply editorial translation modules for siman 276 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-276-editorial.mjs _tr-276-baer-heitev.mjs _tr-276-beer-hagolah.mjs _tr-276-beur-hagra.mjs _tr-276-pitchei-teshuva.mjs _tr-276-rabbi-akiva-eiger-yd.mjs _tr-276-siftei-kohen.mjs _tr-276-turei-zahav.mjs');
  process.exit(1);
}
