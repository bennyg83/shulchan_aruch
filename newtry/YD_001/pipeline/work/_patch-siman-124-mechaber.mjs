...
import { TRANSLATIONS } from './_patch-siman-124-mechaber-translations.mjs';
...
patchFile('siman_124/mechaber/part-001.txt', 'mechaber', TRANSLATIONS);
console.log('[COMPLETE] siman_124/mechaber patched');
