#!/usr/bin/env node
/** Apply editorial translation modules for siman 203 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-203-baer-heitev.mjs',
  '_tr-203-beer-hagolah.mjs',
  '_tr-203-beur-hagra.mjs',
  '_tr-203-pitchei-teshuva.mjs',
  '_tr-203-rabbi-akiva-eiger-yd.mjs',
  '_tr-203-turei-zahav.mjs',
];
