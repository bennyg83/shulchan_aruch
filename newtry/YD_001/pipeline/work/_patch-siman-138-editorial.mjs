#!/usr/bin/env node
/** Apply editorial translation modules for siman 138 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : ["_tr-138-baer-heitev.mjs","_tr-138-beer-hagolah.mjs","_tr-138-beur-hagra.mjs","_tr-138-siftei-kohen.mjs","_tr-138-turei-zahav.mjs"];
