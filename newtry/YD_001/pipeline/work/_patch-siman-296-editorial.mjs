#!/usr/bin/env node
/** Apply editorial translation modules for siman 296 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-296-editorial.mjs _tr-296-baer-heitev.mjs _tr-296-beer-hagolah.mjs _tr-296-beur-hagra.mjs _tr-296-rabbi-akiva-eiger-yd.mjs _tr-296-turei-zahav.mjs');
  process.exit(1);
}
