#!/usr/bin/env node
/** Apply editorial translation modules for siman 248 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-248-editorial.mjs _tr-248-beer-hagolah.mjs _tr-248-beur-hagra.mjs _tr-248-pitchei-teshuva.mjs _tr-248-yad-avraham.mjs');
  process.exit(1);
}
