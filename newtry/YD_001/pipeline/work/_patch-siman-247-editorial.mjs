#!/usr/bin/env node
/** Apply editorial translation modules for siman 247 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-247-editorial.mjs _tr-247-baer-heitev.mjs _tr-247-beer-hagolah.mjs _tr-247-pitchei-teshuva.mjs _tr-247-siftei-kohen.mjs');
  process.exit(1);
}
