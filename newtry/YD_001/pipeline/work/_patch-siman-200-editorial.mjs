#!/usr/bin/env node
/** Apply editorial translation modules for siman 200 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-200-baer-heitev.mjs',
  '_tr-200-beer-hagolah.mjs',
  '_tr-200-beur-hagra.mjs',
  '_tr-200-siftei-kohen.mjs',
  '_tr-200-turei-zahav.mjs',
];
