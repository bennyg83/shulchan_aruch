#!/usr/bin/env node
/** Apply editorial translation modules for siman 226 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-226-editorial.mjs _tr-226-baer-heitev.mjs _tr-226-beur-hagra.mjs _tr-226-nekudot-hakesef.mjs _tr-226-siftei-kohen.mjs _tr-226-turei-zahav.mjs');
  process.exit(1);
}
