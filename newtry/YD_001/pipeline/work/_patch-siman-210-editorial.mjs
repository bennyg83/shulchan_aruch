#!/usr/bin/env node
/** Apply editorial translation modules for siman 210 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-210-baer-heitev.mjs',
  '_tr-210-beur-hagra.mjs',
  '_tr-210-pitchei-teshuva.mjs',
  '_tr-210-rabbi-akiva-eiger-yd.mjs',
  '_tr-210-siftei-kohen.mjs',
  '_tr-210-turei-zahav.mjs',
  '_tr-210-yad-avraham.mjs',
];
