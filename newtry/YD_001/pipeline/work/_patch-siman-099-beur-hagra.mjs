#!/usr/bin/env node
/** Editorial cleanup — siman 099 beur-hagra */
import fs from 'fs';
import path from 'path';
import { fileURLToPath } from 'url';
import { T } from './_patch-siman-099-beur-hagra-translations.mjs';
...
const ENG = '**** ENGLISH ****';
const END = '**** END BLOCK ****';
const REL = 'siman_099/beur-hagra/part-001.txt';
...
fs.appendFileSync(
  ...
  `${ts} siman_099/beur-hagra ${n} blocks editorial CLEAN\n`
);
console.log(`[DONE] siman_099/beur-hagra — ${n} blocks`);
