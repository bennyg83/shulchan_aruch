#!/usr/bin/env node
/** Apply editorial translation modules for siman 281 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-281-editorial.mjs _tr-281-baer-heitev.mjs _tr-281-beer-hagolah.mjs _tr-281-pitchei-teshuva.mjs _tr-281-turei-zahav.mjs');
  process.exit(1);
}
