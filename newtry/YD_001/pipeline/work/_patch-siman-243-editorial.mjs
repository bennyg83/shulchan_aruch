#!/usr/bin/env node
/** Apply editorial translation modules for siman 243 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-243-editorial.mjs _tr-243-baer-heitev.mjs _tr-243-beer-hagolah.mjs _tr-243-beur-hagra.mjs _tr-243-pitchei-teshuva.mjs _tr-243-siftei-kohen.mjs');
  process.exit(1);
}
