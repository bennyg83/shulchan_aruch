#!/usr/bin/env node
/** Apply editorial translation modules for siman 289 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-289-editorial.mjs _tr-289-beer-hagolah.mjs _tr-289-beur-hagra.mjs _tr-289-pitchei-teshuva.mjs _tr-289-siftei-kohen.mjs _tr-289-turei-zahav.mjs');
  process.exit(1);
}
