#!/usr/bin/env node
/** Apply editorial translation modules for siman 244 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-244-editorial.mjs _tr-244-beer-hagolah.mjs _tr-244-beur-hagra.mjs _tr-244-siftei-kohen.mjs _tr-244-turei-zahav.mjs _tr-244-yad-avraham.mjs');
  process.exit(1);
}
