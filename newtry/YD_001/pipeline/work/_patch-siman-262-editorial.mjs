#!/usr/bin/env node
/** Apply editorial translation modules for siman 262 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-262-editorial.mjs _tr-262-baer-heitev.mjs _tr-262-beer-hagolah.mjs _tr-262-beur-hagra.mjs _tr-262-pitchei-teshuva.mjs _tr-262-rabbi-akiva-eiger-yd.mjs _tr-262-siftei-kohen.mjs _tr-262-turei-zahav.mjs');
  process.exit(1);
}
