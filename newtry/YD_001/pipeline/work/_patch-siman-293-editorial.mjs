#!/usr/bin/env node
/** Apply editorial translation modules for siman 293 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-293-editorial.mjs _tr-293-baer-heitev.mjs _tr-293-beer-hagolah.mjs _tr-293-nekudot-hakesef.mjs _tr-293-pitchei-teshuva.mjs _tr-293-rabbi-akiva-eiger-yd.mjs _tr-293-siftei-kohen.mjs');
  process.exit(1);
}
