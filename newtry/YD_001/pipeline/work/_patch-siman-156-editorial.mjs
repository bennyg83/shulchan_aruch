#!/usr/bin/env node
/** Apply editorial translation modules for siman 156 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-156-editorial.mjs _tr-156-beur-hagra.mjs _tr-156-siftei-kohen.mjs');
  process.exit(1);
}
