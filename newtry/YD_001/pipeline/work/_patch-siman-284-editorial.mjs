#!/usr/bin/env node
/** Apply editorial translation modules for siman 284 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-284-editorial.mjs _tr-284-baer-heitev.mjs _tr-284-beer-hagolah.mjs _tr-284-beur-hagra.mjs _tr-284-pitchei-teshuva.mjs');
  process.exit(1);
}
