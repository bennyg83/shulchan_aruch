#!/usr/bin/env node
/** Apply editorial translation modules for siman 186 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-186-editorial.mjs _tr-186-beer-hagolah.mjs _tr-186-beur-hagra.mjs _tr-186-chiddushei-hilkhot-niddah.mjs _tr-186-pitchei-teshuva.mjs _tr-186-siftei-kohen.mjs _tr-186-torat-hashlamim.mjs');
  process.exit(1);
}
