#!/usr/bin/env node
/** Apply editorial translation modules for siman 143 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-143-baer-heitev.mjs',
  '_tr-143-beer-hagolah.mjs',
  '_tr-143-beur-hagra.mjs',
  '_tr-143-siftei-kohen.mjs',
  '_tr-143-turei-zahav.mjs',
];
