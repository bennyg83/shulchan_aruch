#!/usr/bin/env node
/** Apply editorial translation modules for siman 292 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-292-editorial.mjs _tr-292-baer-heitev.mjs _tr-292-beer-hagolah.mjs _tr-292-beur-hagra.mjs _tr-292-pitchei-teshuva.mjs _tr-292-siftei-kohen.mjs _tr-292-turei-zahav.mjs');
  process.exit(1);
}
