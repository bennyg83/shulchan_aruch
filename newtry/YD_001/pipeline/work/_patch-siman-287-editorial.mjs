#!/usr/bin/env node
/** Apply editorial translation modules for siman 287 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-287-editorial.mjs _tr-287-baer-heitev.mjs _tr-287-beer-hagolah.mjs _tr-287-beur-hagra.mjs _tr-287-siftei-kohen.mjs _tr-287-turei-zahav.mjs');
  process.exit(1);
}
