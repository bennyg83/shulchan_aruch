#!/usr/bin/env node
/** Apply editorial translation modules for siman 139 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : ["_tr-139-baer-heitev.mjs","_tr-139-beer-hagolah.mjs","_tr-139-beur-hagra.mjs","_tr-139-siftei-kohen.mjs","_tr-139-turei-zahav.mjs"];
