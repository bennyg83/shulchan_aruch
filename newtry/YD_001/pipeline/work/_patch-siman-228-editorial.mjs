#!/usr/bin/env node
/** Apply editorial translation modules for siman 228 */
import fs from 'fs';
...
if (!modules.length) {
  console.error(
    'Usage: node _patch-siman-228-editorial.mjs _tr-228-baer-heitev.mjs _tr-228-beer-hagolah.mjs _tr-228-beur-hagra.mjs _tr-228-nekudot-hakesef.mjs _tr-228-pitchei-teshuva.mjs _tr-228-rabbi-akiva-eiger-yd.mjs _tr-228-siftei-kohen.mjs _tr-228-turei-zahav.mjs'
  );
  process.exit(1);
}
