#!/usr/bin/env node
/** Apply editorial translation modules for siman 275 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-275-editorial.mjs _tr-275-baer-heitev.mjs _tr-275-beer-hagolah.mjs _tr-275-beur-hagra.mjs _tr-275-nekudot-hakesef.mjs _tr-275-pitchei-teshuva.mjs _tr-275-siftei-kohen.mjs _tr-275-turei-zahav.mjs');
  process.exit(1);
}
