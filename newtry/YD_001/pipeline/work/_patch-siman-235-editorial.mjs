#!/usr/bin/env node
/** Apply editorial translation modules for siman 235 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-235-editorial.mjs _tr-235-baer-heitev.mjs _tr-235-beer-hagolah.mjs _tr-235-beur-hagra.mjs _tr-235-pitchei-teshuva.mjs _tr-235-rabbi-akiva-eiger-yd.mjs _tr-235-siftei-kohen.mjs _tr-235-turei-zahav.mjs');
  process.exit(1);
}
