#!/usr/bin/env node
/** Apply editorial translation modules for siman 167 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-167-editorial.mjs _tr-167-baer-heitev.mjs _tr-167-beer-hagolah.mjs _tr-167-beur-hagra.mjs _tr-167-nekudot-hakesef.mjs _tr-167-rabbi-akiva-eiger-yd.mjs _tr-167-turei-zahav.mjs');
  process.exit(1);
}
