#!/usr/bin/env node
/** Apply editorial translation modules for siman 291 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-291-editorial.mjs _tr-291-beer-hagolah.mjs _tr-291-pitchei-teshuva.mjs _tr-291-siftei-kohen.mjs');
  process.exit(1);
}
