#!/usr/bin/env node
/** Apply editorial translation modules for siman 250 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-250-editorial.mjs _tr-250-beur-hagra.mjs _tr-250-turei-zahav.mjs');
  process.exit(1);
}
