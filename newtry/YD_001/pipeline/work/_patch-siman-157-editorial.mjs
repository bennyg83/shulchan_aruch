#!/usr/bin/env node
/** Apply editorial translation modules for siman 157 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-157-editorial.mjs _tr-157-baer-heitev.mjs _tr-157-beer-hagolah.mjs _tr-157-beur-hagra.mjs _tr-157-pitchei-teshuva.mjs _tr-157-rabbi-akiva-eiger-yd.mjs _tr-157-siftei-kohen.mjs _tr-157-turei-zahav.mjs _tr-157-yad-avraham.mjs');
  process.exit(1);
}
