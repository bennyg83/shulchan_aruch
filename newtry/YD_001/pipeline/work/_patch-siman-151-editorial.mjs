#!/usr/bin/env node
/** Apply editorial translation modules for siman 151 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-151-baer-heitev.mjs',
  '_tr-151-beer-hagolah.mjs',
  '_tr-151-beur-hagra.mjs',
  '_tr-151-pitchei-teshuva.mjs',
  '_tr-151-siftei-kohen.mjs',
  '_tr-151-turei-zahav.mjs',
  '_tr-151-yad-ephraim.mjs',
];
