#!/usr/bin/env node
/** Apply editorial translation modules for siman 269 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-269-editorial.mjs _tr-269-baer-heitev.mjs _tr-269-beer-hagolah.mjs _tr-269-beur-hagra.mjs _tr-269-pitchei-teshuva.mjs _tr-269-rabbi-akiva-eiger-yd.mjs _tr-269-siftei-kohen.mjs');
  process.exit(1);
}
