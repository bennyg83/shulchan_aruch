#!/usr/bin/env node
/** Apply editorial translation modules for siman 152 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-152-baer-heitev.mjs',
  '_tr-152-beer-hagolah.mjs',
  '_tr-152-nekudot-hakesef.mjs',
  '_tr-152-siftei-kohen.mjs',
  '_tr-152-turei-zahav.mjs',
];
