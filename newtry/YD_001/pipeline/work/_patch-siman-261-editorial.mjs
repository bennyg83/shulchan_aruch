#!/usr/bin/env node
/** Apply editorial translation modules for siman 261 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-261-editorial.mjs _tr-261-beur-hagra.mjs _tr-261-yad-avraham.mjs');
  process.exit(1);
}
