#!/usr/bin/env node
/** Apply editorial translation modules for siman 146 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-146-baer-heitev.mjs',
  '_tr-146-beer-hagolah.mjs',
  '_tr-146-beur-hagra.mjs',
  '_tr-146-pitchei-teshuva.mjs',
  '_tr-146-siftei-kohen.mjs',
  '_tr-146-turei-zahav.mjs',
  '_tr-146-yad-ephraim.mjs',
];
