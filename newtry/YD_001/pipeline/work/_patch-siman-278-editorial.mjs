#!/usr/bin/env node
/** Apply editorial translation modules for siman 278 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-278-editorial.mjs _tr-278-baer-heitev.mjs _tr-278-beer-hagolah.mjs _tr-278-beur-hagra.mjs _tr-278-nekudot-hakesef.mjs _tr-278-pitchei-teshuva.mjs _tr-278-siftei-kohen.mjs _tr-278-turei-zahav.mjs');
  process.exit(1);
}
