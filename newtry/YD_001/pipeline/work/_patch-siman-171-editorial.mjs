#!/usr/bin/env node
/** Apply editorial translation modules for siman 171 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-171-editorial.mjs _tr-171-baer-heitev.mjs _tr-171-beer-hagolah.mjs _tr-171-pitchei-teshuva.mjs _tr-171-rabbi-akiva-eiger-yd.mjs _tr-171-siftei-kohen.mjs');
  process.exit(1);
}
