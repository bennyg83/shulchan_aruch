#!/usr/bin/env node
/** Apply editorial translation modules for siman 277 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-277-editorial.mjs _tr-277-nekudot-hakesef.mjs _tr-277-siftei-kohen.mjs');
  process.exit(1);
}
