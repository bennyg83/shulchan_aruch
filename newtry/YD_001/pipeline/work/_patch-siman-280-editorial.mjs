#!/usr/bin/env node
/** Apply editorial translation modules for siman 280 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-280-editorial.mjs _tr-280-baer-heitev.mjs _tr-280-beer-hagolah.mjs _tr-280-beur-hagra.mjs _tr-280-siftei-kohen.mjs _tr-280-turei-zahav.mjs');
  process.exit(1);
}
