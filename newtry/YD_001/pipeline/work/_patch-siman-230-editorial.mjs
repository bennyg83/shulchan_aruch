#!/usr/bin/env node
/** Apply editorial translation modules for siman 230 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-230-editorial.mjs _tr-230-baer-heitev.mjs _tr-230-beur-hagra.mjs _tr-230-pitchei-teshuva.mjs _tr-230-siftei-kohen.mjs');
  process.exit(1);
}
