#!/usr/bin/env node
/** Apply editorial translation modules for siman 285 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-285-editorial.mjs _tr-285-beur-hagra.mjs _tr-285-pitchei-teshuva.mjs _tr-285-rabbi-akiva-eiger-yd.mjs');
  process.exit(1);
}
