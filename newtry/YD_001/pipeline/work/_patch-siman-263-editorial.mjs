#!/usr/bin/env node
/** Apply editorial translation modules for siman 263 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-263-editorial.mjs _tr-263-beer-hagolah.mjs _tr-263-beur-hagra.mjs _tr-263-pitchei-teshuva.mjs _tr-263-rabbi-akiva-eiger-yd.mjs _tr-263-siftei-kohen.mjs _tr-263-turei-zahav.mjs');
  process.exit(1);
}
