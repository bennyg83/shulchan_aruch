#!/usr/bin/env node
/** Apply editorial translation modules for siman 175 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-175-editorial.mjs _tr-175-baer-heitev.mjs _tr-175-beer-hagolah.mjs _tr-175-beur-hagra.mjs _tr-175-pitchei-teshuva.mjs _tr-175-siftei-kohen.mjs _tr-175-turei-zahav.mjs _tr-175-yad-avraham.mjs');
  process.exit(1);
}
