#!/usr/bin/env node
/** Apply editorial translation modules for siman 264 */
import fs from 'fs';
...
if (!modules.length) {
  console.error('Usage: node _patch-siman-264-editorial.mjs _tr-264-baer-heitev.mjs _tr-264-beer-hagolah.mjs _tr-264-beur-hagra.mjs _tr-264-nekudot-hakesef.mjs _tr-264-pitchei-teshuva.mjs _tr-264-siftei-kohen.mjs _tr-264-turei-zahav.mjs _tr-264-yad-avraham.mjs');
  process.exit(1);
}
