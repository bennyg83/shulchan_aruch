#!/usr/bin/env node
/** Apply editorial translation modules for siman 204 */
import fs from 'fs';
...
const modules = process.argv.slice(2).length ? process.argv.slice(2) : [
  '_tr-204-baer-heitev.mjs',
  '_tr-204-beer-hagolah.mjs',
  '_tr-204-pitchei-teshuva.mjs',
  '_tr-204-rabbi-akiva-eiger-yd.mjs',
  '_tr-204-siftei-kohen.mjs',
  '_tr-204-turei-zahav.mjs',
];
