#!/usr/bin/env node
/**
 * Quality validation for YD001 English (post machine translation).
 *
 *   node pipeline/validate-quality-yd001.mjs --root output
 *   node pipeline/validate-quality-yd001.mjs --root output --siman 308
 *   node pipeline/validate-quality-yd001.mjs --root output --min-severity warn --fail-on error
 *   node pipeline/validate-quality-yd001.mjs --root output --write-reports
 */
import fs from "fs";
