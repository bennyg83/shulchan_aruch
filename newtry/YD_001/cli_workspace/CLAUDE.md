# CLAUDE.md — YD001 CLI workspace

This folder is the **working directory** for Claude Code / CLI agents on Yoreh De'ah.
...
```powershell
cd newtry/YD_001/cli_workspace
