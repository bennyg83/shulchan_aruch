/**
 * Replaces each occurrence of the OC253 English placeholder with the next string
 * from a JSON array (in file order). Usage:
...
if (idx !== translations.length) {
  console.warn(
    `Warning: used ${idx} translations but JSON has ${translations.length} entries.`
  );
}

const pendingLeft = (out.match(new RegExp(PLACEHOLDER.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "g")) || []).length;
if (pendingLeft) {
