/**
 * Per-source OC 253 translation files: blocks keyed by slug / seif / marker.
 */
export const BLOCK_START = "**** OC253 SOURCE BLOCK ****";
...
export function parseBlocksInFile(raw) {
  ...
  const segments = text.split(new RegExp(`^${escapeRegExp(BLOCK_START)}\\s*$`, "m"));
  const out = [];
