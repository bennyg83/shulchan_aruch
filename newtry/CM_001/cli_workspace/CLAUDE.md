# CLAUDE.md — CM001 CLI workspace

This folder is the **working directory** for Claude Code / CLI agents on Choshen Mishpat.
...
```powershell
cd newtry/CM_001/cli_workspace
