...
function pingSlave() {
  const url = (process.env.CM001_OLLAMA_URL || "http://10.100.102.14:11434").replace(/\/$/, "");
...
function main() {
  ...
  if (!pingSlave()) {
    ...
    console.error("  powershell -ExecutionPolicy Bypass -File C:\\cm001-slave\\Start-OllamaServe.ps1");
    process.exit(1);
  }
