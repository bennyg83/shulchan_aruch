...
```bash
cd newtry/CM_001
export CM001_POOL_BACKEND=ollama
export CM001_OLLAMA_URL=http://10.100.102.14:11434
export CM001_OLLAMA_MODEL_TRANSLATE=qwen2.5:14b-instruct
...
```bash
export CM001_POOL_BACKEND=claude-cli
