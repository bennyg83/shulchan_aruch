...
**Daily on slave:** `powershell -ExecutionPolicy Bypass -File C:\cm001-slave\Start-OllamaServe.ps1`
...
```
CM001_OLLAMA_URL=http://10.100.102.14:11434
CM001_OLLAMA_MODEL=qwen2.5:14b-instruct
```
