...
2. **`newtry/OC_Mobile/oc318-mobile-reader/public/corpus/cm1/`** — `en.html` per source (if present)
...
4. For published simanim: re-run `node pipeline/orchestrator.mjs publish --siman N` after CM001 files are clean
