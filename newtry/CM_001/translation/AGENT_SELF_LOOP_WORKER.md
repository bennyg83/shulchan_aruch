...
```
You are CM001 editorial worker SLOT of 4 (cm001-worker-SLOT). Run until cm_complete with NO user prompts.
...
Do not stop or ask the user unless cm_complete or a hard error after 3 retries.
```
