# CM001 editorial re-translation (Cursor / agent)
...
**Source of truth:** `newtry/CM_001/output/siman_NNN/<commentary>/part-*.txt`.  
...
Use the dictionary; these recur in Choshen Mishpat:
...
Simanim **1–5** first, then stress simanim **87** (melicha) and **115** (basar b'chalav) per `CM_CHOSHEN_MISHPAT_PLAN.md`.
