...
# export CM001_OLLAMA_URL=http://10.100.102.14:11434
# export CM001_OLLAMA_MODEL=qwen2.5:14b-instruct
...
5. Auto-advances phases and **waves** through siman **427** (`finishThrough` in `master-pipeline-plan.json`)
...
| Phase | Action |
|-------|--------|
| `editorial_6_403` | Watch spawns workers; waves 105→100→296→…→427 |
| `html_presentation` | Stop watch; one HTML agent; `mark-html-complete` |
| `cm_complete` | Watch exits |
