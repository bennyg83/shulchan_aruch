...
| `EN_MISSING_PACK` | en_missing | 20 | 1 | 37,940 | `5a2849c98bb2…` | [`EN_MISSING_PACK.json`](./EN_MISSING_PACK.json) |
...
- **EN_MISSING_PACK**: HE present, EN absent — locate approved EN source (not old MT unless authorized)
