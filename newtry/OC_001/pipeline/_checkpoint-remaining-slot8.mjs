...
if (!siman) {
  console.error("usage: node _checkpoint-remaining-slot8.mjs <siman>");
  process.exit(1);
}
...
const fin = spawnSync(process.execPath, [path.join(__dirname, "_finalize-siman-slot8.mjs"), String(siman)], {
  cwd: OC_ROOT,
  stdio: "inherit",
});
