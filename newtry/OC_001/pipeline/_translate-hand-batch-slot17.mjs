#!/usr/bin/env node
/** Translate missing hand-slot17 items via claude --print */
import fs from "fs";
...
const TOPICS = {
  663: "Chol Hamoed prayer order, Torah reading holiday sacrifices from Pinchas, safek yom, Israel practice, Shabbat Chol Hamoed Amidah, Ecclesiastes, two Torah scrolls haftarah Gog",
  664: "Hoshana Rabbah, psalms like Yom Tov, beating aravot, willow Hoshanot, water libation, moon shadow sign, kittel, lulav binding, circling bimah seven times",
  665: "etrog muktzeh all seven days, Shemini Atzeret permitted, diaspora ninth day Simchat Torah Sunday",
  666: "sukkah not dismantled seventh day, remove utensils Mincha, four by four tefachim distinction Shemini Atzeret, diaspora ninth day candle pots",
  667: "sukkah decorations forbidden eighth ninth safek, Shabbat after holiday, Leviathan sukkah prayer, preparation on Yom Tov for next night",
  668: "Shemini Atzeret night day Amidah atzeret, diaspora eat in sukkah safek seventh, no leishev, Kiddush zman, Torah reading",
};
const TOPIC = TOPICS[siman] || "Sukkot end of holiday laws";
...
- Halachic terms: Chol Hamoed, Yom Tov, Shemini Atzeret, sukkah, sekhakh, lulav, etrog, Hoshana Rabbah, musaf, Arvit, Shacharit, Mincha, haftarah, maftir, kohen Levi Yisrael, safek yom, l'chatchila, b'dieved, d'oraisa, d'rabbanan, muktzeh, melacha, etc.
- Commentator names exactly: Magen Avraham, Taz, Beit Yosef, Rambam, Mishna Berurah, Bach, Gra, Ran, Rosh, Rashba, Eliyah Rabbah, Kaf HaChayyim, Peri Megadim, Chokhmat Shlomo, Levush, Maharil, Shaarei Teshuvah, etc.
...
- Use Chol Hamoed not Hol Hamoed.

FORBIDDEN: Lord, God (use Hashem), Shield of Abraham, Golden Rows, hand recoils, first dish, allocated, Saturday, According to the, there in the, Bible, Capernaum, &quot;, Rem"a, Spike Duma, Quran, Audience, lines of dots, duplicate repeated phrases.
