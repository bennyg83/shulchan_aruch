#!/usr/bin/env node
/** worker-slot-8 — sprint simanim 319-326 to COMPLETE */
import fs from "fs";
...
const startFrom = parseInt(process.argv[2], 10) || 319;
const results = [];
...
fs.appendFileSync(LOG, `${slotTs} worker-slot-8 SLOT COMPLETE simanim 319-326\n`, "utf8");
console.log("\n--- Summary ---");
