#!/usr/bin/env node
/**
 * Build slot6 batch data + apply scripts from work/hand-slot6-siman-NNN.json
 * Usage: node pipeline/_build-slot6-siman.mjs 257
 */
import fs from "fs";
...
if (!siman) throw new Error("Usage: _build-slot6-siman.mjs <siman>");
