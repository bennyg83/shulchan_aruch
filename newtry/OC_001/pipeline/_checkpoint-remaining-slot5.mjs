...
if (!siman) {
  console.error("usage: node _checkpoint-remaining-slot5.mjs <siman>");
  process.exit(1);
}
...
const fin = spawnSync(process.execPath, [path.join(__dirname, "_finalize-siman-slot5.mjs"), String(siman)], {
  cwd: OC_ROOT,
  stdio: "inherit",
});
