#!/usr/bin/env node
/**
 * Build slot8 batch data + apply scripts from work/hand-slot8-siman-NNN.json
 * Usage: node pipeline/_build-slot8-siman.mjs 257
 */
import fs from "fs";
...
if (!siman) throw new Error("Usage: _build-slot8-siman.mjs <siman>");
