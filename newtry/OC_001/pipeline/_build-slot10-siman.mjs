#!/usr/bin/env node
/**
 * Build slot10 batch data + apply scripts from work/hand-slot10-siman-NNN.json
 * Usage: node pipeline/_build-slot10-siman.mjs 257
 */
import fs from "fs";
...
if (!siman) throw new Error("Usage: _build-slot10-siman.mjs <siman>");
