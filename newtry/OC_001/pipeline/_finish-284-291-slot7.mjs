#!/usr/bin/env node
/** worker-slot-7 — sprint simanim 284-291 to COMPLETE */
import fs from "fs";
...
const startFrom = parseInt(process.argv[2], 10) || 284;
const results = [];
...
fs.appendFileSync(LOG, `${slotTs} worker-slot-7 SLOT COMPLETE simanim 284-291\n`, "utf8");
console.log("\n--- Summary ---");
