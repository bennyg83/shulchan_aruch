#!/usr/bin/env node
/** worker slot 3 — siman 431 (bedikat chametz — time of search) */
import fs from "fs";
import { parseBlocksInFile, serializeBlock } from "../oc001_block_lib.mjs";
import { fixes } from "./_fixes-siman431.mjs";
...
console.log("TOTAL", total, "/", Object.values(fixes).reduce((s, o) => s + Object.keys(o).length, 0));
if (risks.length) {
