...
const SLOT = "9";
const SLOT_DASH = "slot9";
const WORKER = "worker-slot-9";
...
function xform(name, text) {
  let out = text
    ...
    .replaceAll("hand-slot8", "hand-slot9")
    .replaceAll("_slot8-lib.mjs", "_slot9-lib.mjs")
    .replaceAll("-slot8", "-slot9")
    .replaceAll("slot8", "slot9");
  const outName = name.replaceAll("slot8", "slot9");
  return [outName, out];
}
