...
export const PART2 = ["chok-yaakov","beur-hagra"];
export const PART3 = ["biur-halacha","dagul-merevavah","eliyah-rabbah","kaf-hachayyim","levushei-serad","yad-ephraim"];
...
for (const pn of [1, 2, 3]) {
  fs.writeFileSync(
    path.join(__dirname, `he483-bad-p${pn}.json`),
    JSON.stringify(badKeys[pn], null, 2) + "\n"
  );
  console.log(`he483-bad-p${pn}.json`, badKeys[pn].length);
}
