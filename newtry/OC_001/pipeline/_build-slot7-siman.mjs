#!/usr/bin/env node
/**
 * Build slot7 batch data + apply scripts from work/hand-slot7-siman-NNN.json
 * Usage: node pipeline/_build-slot7-siman.mjs 257
 */
import fs from "fs";
...
if (!siman) throw new Error("Usage: _build-slot7-siman.mjs <siman>");
