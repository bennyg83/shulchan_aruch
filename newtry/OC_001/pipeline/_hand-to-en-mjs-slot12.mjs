#!/usr/bin/env node
/** Convert hand-slot12-siman-NNN.json → mechNNN-en.mjs + smallNNN-en.mjs */
import fs from "fs";
...
writeMap(smallPath, "t", small, `OC siman ${siman} commentators`);
console.log("wrote", mechPath, smallPath);
