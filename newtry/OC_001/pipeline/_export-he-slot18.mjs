#!/usr/bin/env node
/** Export Hebrew blocks for slot18 hand translation: work/hand-slot18-siman-NNN.json */
import fs from "fs";
import path from "path";
import { fileURLToPath } from "url";
import { parseBlocksInFile } from "../oc001_block_lib.mjs";
import { collectEditorialBlocks, loadEditorialDoneIds } from "./lib/editorial-queue.mjs";
import { hePlain, blockKey } from "./_slot18-lib.mjs";
...
if (!siman) throw new Error("Usage: _export-he-slot18.mjs <siman>");
...
const outPath = path.join(WORK, `hand-slot18-siman-${siman}.json`);
