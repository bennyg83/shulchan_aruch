#!/usr/bin/env node
/** Export Hebrew blocks for slot11 hand translation: work/hand-slot11-siman-NNN.json */
import fs from "fs";
...
if (!siman) throw new Error("Usage: _export-he-slot11.mjs <siman>");
...
const outPath = path.join(WORK, `hand-slot11-siman-${siman}.json`);
