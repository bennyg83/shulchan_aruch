...
function setEnglish(rel, slug, seif, marker, newEn) {
  ...
  console.log(`OK ${rel} seif=${seif} marker=${marker}`);
}

const rel = "siman_158/machatzit-hashekel/part-001.txt";
setEnglish(rel, "machatzit-hashekel", 4, "א", read("en-158-mh-4a.txt"));
setEnglish(rel, "machatzit-hashekel", 13, "א", read("en-158-mh-13a.txt"));
