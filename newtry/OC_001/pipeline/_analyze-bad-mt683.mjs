...
export const PART1 = ["mechaber","mishnah-berurah","turei-zahav","beer-hagolah","baer-heitev"];
export const PART2 = ["peri-megadim"];
export const PART3 = ["eliyah-rabbah","kaf-hachayyim","shaarei-teshuvah","chokhmat-shlomo"];
...
for (const pn of [1, 2, 3]) {
  fs.writeFileSync(
    path.join(__dirname, `he683-bad-p${pn}.json`),
    JSON.stringify(badKeys[pn], null, 2) + "\n"
  );
  console.log(`he683-bad-p${pn}.json`, badKeys[pn].length);
}
