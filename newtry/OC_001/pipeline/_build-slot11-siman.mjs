#!/usr/bin/env node
/**
 * Build slot11 batch data + apply scripts from work/hand-slot11-siman-NNN.json
 * Usage: node pipeline/_build-slot11-siman.mjs 257
 */
import fs from "fs";
...
if (!siman) throw new Error("Usage: _build-slot11-siman.mjs <siman>");
