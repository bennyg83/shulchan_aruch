#!/usr/bin/env node
/**
 * Build slot5 batch data + apply scripts from work/hand-slot5-siman-NNN.json
 * Usage: node pipeline/_build-slot5-siman.mjs 221
 */
import fs from "fs";
...
if (!siman) throw new Error("Usage: _build-slot5-siman.mjs <siman>");
