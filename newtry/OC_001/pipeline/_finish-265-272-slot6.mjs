#!/usr/bin/env node
/** Finish simanim 265–272: apply batches → finalize → log COMPLETE */
import fs from "fs";
...
const results = [];
const startFrom = parseInt(process.argv[2], 10) || 265;
...
fs.appendFileSync(LOG, `${slotTs} worker-slot-6 SLOT COMPLETE simanim 265-272\n`, "utf8");
console.log("\n--- Summary ---");
