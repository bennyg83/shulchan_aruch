...
const rel = "siman_158/peri-megadim/part-001.txt";
const t = fs.readFileSync(path.join(WORK, "en-158-p6-pmg.txt"), "utf8");

function setEnglish(slug, seif, marker, key) {
...
setEnglish("peri-megadim", 1, "ב", "1ב");
setEnglish("peri-megadim", 4, "_", "4");
setEnglish("peri-megadim", 11, "א", "11א");
setEnglish("peri-megadim", 11, "ב", "11ב");
