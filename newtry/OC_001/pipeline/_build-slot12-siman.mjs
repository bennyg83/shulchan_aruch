#!/usr/bin/env node
/**
 * Build slot12 batch data + apply scripts from work/hand-slot12-siman-NNN.json
 * Usage: node pipeline/_build-slot12-siman.mjs 257
 */
import fs from "fs";
...
if (!siman) throw new Error("Usage: _build-slot12-siman.mjs <siman>");
