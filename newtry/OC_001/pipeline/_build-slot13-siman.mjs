#!/usr/bin/env node
/**
 * Build slot13 batch data + apply scripts from work/hand-slot13-siman-NNN.json
 * Usage: node pipeline/_build-slot13-siman.mjs 257
 */
import fs from "fs";
...
if (!siman) throw new Error("Usage: _build-slot13-siman.mjs <siman>");
