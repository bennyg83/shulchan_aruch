...
if (!siman) {
  console.error("usage: node _checkpoint-remaining-slot9.mjs <siman>");
  process.exit(1);
}
...
const fin = spawnSync(process.execPath, [path.join(__dirname, "_finalize-siman-slot9.mjs"), String(siman)], {
  cwd: OC_ROOT,
  stdio: "inherit",
});
