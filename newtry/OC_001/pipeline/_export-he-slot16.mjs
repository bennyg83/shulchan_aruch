#!/usr/bin/env node
/** Export Hebrew blocks for slot16 hand translation: work/hand-slot16-siman-NNN.json */
import fs from "fs";
import path from "path";
import { fileURLToPath } from "url";
import { parseBlocksInFile } from "../oc001_block_lib.mjs";
import { collectEditorialBlocks, loadEditorialDoneIds } from "./lib/editorial-queue.mjs";
import { hePlain, blockKey } from "./_slot16-lib.mjs";
...
if (!siman) throw new Error("Usage: _export-he-slot16.mjs <siman>");
...
const outPath = path.join(WORK, `hand-slot16-siman-${siman}.json`);
