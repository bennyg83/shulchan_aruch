...
const t = fs.readFileSync(path.join(WORK, "en-159-p11.txt"), "utf8");

const patches = [
  ["siman_159/peri-megadim/part-001.txt", "peri-megadim", 8, "_", "pmg8"],
  ["siman_159/rabbi-akiva-eiger/part-001.txt", "rabbi-akiva-eiger", 6, "_", "rae6"],
  ["siman_159/shaarei-teshuvah/part-001.txt", "shaarei-teshuvah", 2, "_", "st2"],
  ["siman_159/turei-zahav/part-001.txt", "turei-zahav", 12, "_", "taz12"],
];
