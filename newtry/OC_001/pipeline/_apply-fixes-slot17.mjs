#!/usr/bin/env node
/** Apply _fixes-simanNNN-slot17.mjs to output */
import fs from "fs";
...
if (!siman) throw new Error("Usage: _apply-fixes-slot17.mjs <siman>");

const fixesPath = path.join(__dirname, `_fixes-siman${siman}-slot17.mjs`);
