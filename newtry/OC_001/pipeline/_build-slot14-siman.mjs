#!/usr/bin/env node
/**
 * Build slot14 batch data + apply scripts from work/hand-slot14-siman-NNN.json
 * Usage: node pipeline/_build-slot14-siman.mjs 257
 */
import fs from "fs";
...
if (!siman) throw new Error("Usage: _build-slot14-siman.mjs <siman>");
