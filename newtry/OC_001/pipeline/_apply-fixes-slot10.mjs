#!/usr/bin/env node
/** Apply _fixes-simanNNN-slot10.mjs directly to output (bypass hand-json pipeline) */
import fs from "fs";
...
if (!siman) throw new Error("Usage: _apply-fixes-slot10.mjs <siman>");

const fixesPath = path.join(__dirname, `_fixes-siman${siman}-slot10.mjs`);
