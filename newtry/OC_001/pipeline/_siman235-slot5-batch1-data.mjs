/** worker-slot-5 — siman 235 editorial batch 1 fixes (45 blocks) */
export const FIXES = {
  ...
  "beer-hagolah/part-001.txt": {
    ...
    "1:ב":
      `Shabbos 35.`,
    "1:ג":
      `Rabbeinu Yonah there in Berachos.`,
    "1:ד":
      `So Beit Yosef ruled for halachah.`,
    "1:ה":
      `There.`,
    "2:א":
    ...
    "3:ב":
      `There — and like the Sages.`,
    "4:א":
      `There 40 — like Rashbi because of R' Akiva.`,
    "4:ב":
      `There in the Gemara.`,
  },
  "beur-hagra/part-001.txt": {
    ...
    "1:ג":
      `<b>Small stars.</b> Taz and Magen Avraham:`,
    "1:ד":
