#!/usr/bin/env node
/**
 * Build slot15 batch data + apply scripts from work/hand-slot15-siman-NNN.json
 * Usage: node pipeline/_build-slot15-siman.mjs 257
 */
import fs from "fs";
...
if (!siman) throw new Error("Usage: _build-slot15-siman.mjs <siman>");
