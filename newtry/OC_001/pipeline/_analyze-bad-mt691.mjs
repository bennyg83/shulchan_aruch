...
export const PART3 = ["biur-halacha","chatam-sofer","eliyah-rabbah","kaf-hachayyim","levushei-serad","rabbi-akiva-eiger","shaarei-teshuvah","yad-ephraim","chokhmat-shlomo","kol-yaakov"];
...
for (const pn of [1, 2, 3]) {
  fs.writeFileSync(
    path.join(__dirname, `he691-bad-p${pn}.json`),
    JSON.stringify(badKeys[pn], null, 2) + "\n"
  );
  console.log(`he691-bad-p${pn}.json`, badKeys[pn].length);
}
