...
const t = fs.readFileSync(path.join(__dirname, "work", "en-160-p5.txt"), "utf8");

const patches = [
  ["siman_160/magen-avraham/part-001.txt", "magen-avraham", 4, "_", "ma4"],
  ["siman_160/magen-avraham/part-001.txt", "magen-avraham", 12, "א", "ma12a"],
];
