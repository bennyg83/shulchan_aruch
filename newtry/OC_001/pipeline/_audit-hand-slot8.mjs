#!/usr/bin/env node
/** Audit hand-slot8: which items need real translation vs pass quality */
import fs from "fs";
import path from "path";
import { fileURLToPath } from "url";
import { parseBlocksInFile } from "../oc001_block_lib.mjs";
import { autoFix, preflightFail } from "./_slot8-lib.mjs";
...
const hand = JSON.parse(
  fs.readFileSync(path.join(__dirname, "work", `hand-slot8-siman-${siman}.json`), "utf8")
);
