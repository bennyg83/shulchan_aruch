#!/usr/bin/env node
/**
 * Build slot17 batch data + apply scripts from work/hand-slot17-siman-NNN.json
 * Usage: node pipeline/_build-slot17-siman.mjs 257
 */
import fs from "fs";
...
if (!siman) throw new Error("Usage: _build-slot17-siman.mjs <siman>");
