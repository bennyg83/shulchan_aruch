#!/usr/bin/env node
/**
 * Build slot16 batch data + apply scripts from work/hand-slot16-siman-NNN.json
 * Usage: node pipeline/_build-slot16-siman.mjs 257
 */
import fs from "fs";
...
if (!siman) throw new Error("Usage: _build-slot16-siman.mjs <siman>");
