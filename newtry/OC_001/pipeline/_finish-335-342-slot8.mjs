#!/usr/bin/env node
/** worker-slot-8 — sprint simanim 335-342 to COMPLETE */
import fs from "fs";
...
const startFrom = parseInt(process.argv[2], 10) || 335;
const results = [];
...
fs.appendFileSync(LOG, `${slotTs} worker-slot-8 SLOT COMPLETE simanim 335-342\n`, "utf8");
console.log("\n--- Summary ---");
