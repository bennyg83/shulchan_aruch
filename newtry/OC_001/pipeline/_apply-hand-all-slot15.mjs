#!/usr/bin/env node
/** Apply every hand-slot15 item.en to output (full siman) */
import fs from "fs";
import path from "path";
import { fileURLToPath } from "url";
import { parseBlocksInFile, serializeBlock } from "../oc001_block_lib.mjs";
import { autoFix, preflightFail, loadHandJson } from "./_slot15-lib.mjs";

const siman = parseInt(process.argv[2], 10);
if (!siman) throw new Error("Usage: _apply-hand-all-slot15.mjs <siman>");
