#!/usr/bin/env node
/** Export Hebrew blocks for slot7 hand translation: work/hand-slot7-siman-NNN.json */
import fs from "fs";
import path from "path";
import { fileURLToPath } from "url";
import { parseBlocksInFile } from "../oc001_block_lib.mjs";
import { collectEditorialBlocks, loadEditorialDoneIds } from "./lib/editorial-queue.mjs";
import { hePlain, blockKey } from "./_slot7-lib.mjs";
...
if (!siman) throw new Error("Usage: _export-he-slot7.mjs <siman>");
...
const outPath = path.join(WORK, `hand-slot7-siman-${siman}.json`);
