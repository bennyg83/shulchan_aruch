#!/usr/bin/env node
/**
 * Build slot18 batch data + apply scripts from work/hand-slot18-siman-NNN.json
 * Usage: node pipeline/_build-slot18-siman.mjs 257
 */
import fs from "fs";
...
if (!siman) throw new Error("Usage: _build-slot18-siman.mjs <siman>");
