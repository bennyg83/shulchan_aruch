#!/usr/bin/env node
/** worker slot 3 — siman 442 part 1 (ta'aruvot chametz) */
import fs from "fs";
import { parseBlocksInFile, serializeBlock } from "./oc001_block_lib.mjs";
import { fixes } from "./pipeline/_fixes-siman442-part1.mjs";
...
const PREFLIGHT = [
  ...
  /\bCapernaum\b/i,
  /&quot;/,
  /\bthere in the (?:midst|world|name)\b/i,
  /\bAccording to the (?:Lord|Torah|Halacha|opinion)\b/i,
  /\bin me\b/i,
  /\bDarbanan\b/i,
  /\bhand recoils\b/i,
  /\bfirst dish\b/i,
...
console.log("PART1 TOTAL", total, "/", expectedTotal);
