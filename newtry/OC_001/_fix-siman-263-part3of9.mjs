...
import { TRANSLATIONS } from "./_siman263-part3of9-translations.mjs";
...
const FILE_BY_SLUG = {
  "beur-hagra": "output/siman_263/beur-hagra/part-001.txt",
  "biur-halacha": "output/siman_263/biur-halacha/part-001.txt",
...
console.log(`ok siman 263 part 3/9 — ${patchCount} blocks`);

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const OC_ROOT = __dirname;
const queuePath = path.join(
  OC_ROOT,
  "pipeline/work/editorial-queue-siman-263-part3of9.json",
);
