...
import { TRANSLATIONS } from "./pipeline/work/_siman-263-part2of9-en.mjs";
...
const FILE_BY_SLUG = {
  "beer-hagolah": "output/siman_263/beer-hagolah/part-001.txt",
...
console.log(`ok siman 263 part2of9 — ${patchCount} blocks`);

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const OC_ROOT = __dirname;
const queuePath = path.join(
  OC_ROOT,
  "pipeline/work/editorial-queue-siman-263-part2of9.json",
);
