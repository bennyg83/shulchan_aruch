...
import { TRANSLATIONS } from "./_siman263-part8of9-translations.mjs";
...
console.log(`ok siman 263 part8of9 — ${patchCount} blocks`);

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const OC_ROOT = __dirname;
const queuePath = path.join(
  OC_ROOT,
  "pipeline/work/editorial-queue-siman-263-part8of9.json",
);
...
function rebuildQueueIfEmpty() {
  ...
  const slice = all.slice((8 - 1) * size, (8 - 1) * size + size);
  queue = {
