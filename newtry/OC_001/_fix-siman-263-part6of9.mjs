...
import { TRANSLATIONS } from "./_siman263-part6of9-translations.mjs";
...
console.log(`ok siman 263 part6of9 — ${patchCount} blocks`);

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const OC_ROOT = __dirname;
const queuePath = path.join(
  OC_ROOT,
  "pipeline/work/editorial-queue-siman-263-part6of9.json",
);
