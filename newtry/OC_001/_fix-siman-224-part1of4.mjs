...
import { TRANSLATIONS } from "./_siman224-part1of4-translations.mjs";
...
const az = "output/siman_224/ateret-zekenim/part-001.txt";
const bh = "output/siman_224/baer-heitev/part-001.txt";
const bhg = "output/siman_224/beer-hagolah/part-001.txt";
...
console.log(`ok siman 224 part1of4 — ${patchCount} blocks`);

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const OC_ROOT = __dirname;
const queuePath = path.join(
  OC_ROOT,
  "pipeline/work/editorial-queue-siman-224-part1of4.json",
);
