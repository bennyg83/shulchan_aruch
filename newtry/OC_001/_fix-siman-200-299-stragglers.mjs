...
import { TRANSLATIONS } from "./_siman200-299-stragglers-translations.mjs";

const SIMANIM = [
  201, 204, 206, 208, 209, 211, 216, 217, 218, 221, 223, 224, 225, 229, 230,
  240, 244, 246, 254, 257, 263, 267, 268, 271, 276, 277, 282, 288, 291, 293,
  294, 299,
];
...
console.log(`ok siman 200-299 stragglers — ${patchCount} blocks patched`);
