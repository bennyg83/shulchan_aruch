...
# export OC001_OLLAMA_URL=http://10.100.102.14:11434
# export OC001_OLLAMA_MODEL=qwen2.5:14b-instruct
...
5. Auto-advances phases and **waves** through siman **697** (`finishThrough` in `master-pipeline-plan.json`)
...
| Phase | Action |
|-------|--------|
| `editorial_105_697` | Watch spawns workers; waves 105→200→296→…→697 |
| `html_presentation` | Stop watch; one HTML agent; `mark-html-complete` |
| `oc_complete` | Watch exits |
