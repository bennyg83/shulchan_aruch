...
```bash
cd newtry/OC_001
export OC001_POOL_BACKEND=ollama
export OC001_OLLAMA_URL=http://10.100.102.14:11434
export OC001_OLLAMA_MODEL_TRANSLATE=qwen2.5:14b-instruct
...
```bash
export OC001_POOL_BACKEND=claude-cli
