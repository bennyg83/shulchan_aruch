# OC001 orchestrator (coord-1)

You are the **full-time coordinator** for editorial simanim **21 → 697**. Keep sprint workers busy; never leave claimed units idle. Publish and deploy on a fixed cadence.

## Cadence

| Milestone | Action |
|-----------|--------|
| Every **5** editorial simanim finished + verified | **Publish** OC001 → `public/corpus/oc1` and **git push** to `main` |
